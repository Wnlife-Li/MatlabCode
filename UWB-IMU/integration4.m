...
% hold on;
for i=1:30
   d_UWB_4(R_UWB_4_U(i))= d_UWB_4(R_UWB_4_U(i))+0.6+rand(1);
end
...
% for i=1:30
%    d_UWB_6(R_UWB_6_U(i))= d_UWB_6(R_UWB_6_U(i))+0.5+rand(1);
% end
% 
% %给1基站加入30个正向偏差
...
% for i=1:30
%    d_UWB_1(R_UWB_1_U(i))= d_UWB_1(R_UWB_1_U(i))+0.5+rand(1);
% end
